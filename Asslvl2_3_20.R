...
data.table::fwrite(ISDaten, "D:/Daten/asmblglvl2/Insample_solution_avgweights_3.csv")
data.table::fwrite(OOSDaten, "D:/Daten/asmblglvl2/Outofsample_solution_avgweights_3.csv")
saveRDS(Asslvl2, "D:/Daten/asmblglvl2/Asslvl2_3.rds")

ploten1 <- ploten1 +
  ggtitle("Plot Outofsample")
ggsave("D:/Daten/Outofsample_lvl2_3_Plot.pdf", height = 7.5, width = 10)

ploten2 <- ploten2 +
  ggtitle("Plot Insample")
ggsave("D:/Daten/Insample_lvl2_3_Plot.pdf", height = 7.5, width = 10)
