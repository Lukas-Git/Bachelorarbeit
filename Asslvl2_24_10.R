...
data.table::fwrite(ISDaten, "D:/Daten/asmblglvl2/Insample_solution_avgweightslvl2_24_10.csv")
data.table::fwrite(OOSDaten, "D:/Daten/asmblglvl2/Outofsample_solution_avgweightslvl2_24_10.csv")
saveRDS(Asslvl2, "D:/Daten/asmblglvl2/Asslvl2_24_10.rds")

ploten1 <- ploten1 +
            ggtitle("Plot Outofsample")
ggsave("D:/Daten/Outofsample_lvl2_24_10_Plot.pdf", height = 7.5, width = 10)

ploten2 <- ploten2 +
  ggtitle("Plot Insample")
ggsave("D:/Daten/Insample_lvl2_24_10_Plot.pdf", height = 7.5, width = 10)
