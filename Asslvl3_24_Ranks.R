...
data.table::fwrite(ISDaten, "D:/Daten/asmblglvl2/Insample_solution_lvl3_24_ranks.csv")
data.table::fwrite(OOSDaten, "D:/Daten/asmblglvl2/Outofsample_solution_lvl3_24_ranks.csv")
saveRDS(Asslvl2, "D:/Daten/asmblglvl2/Asslvl3_lvl3_24_ranks.rds")

ploten1 <- ploten1 +
  ggtitle("Plot Outofsample")
ggsave("D:/Daten/Outofsample_lvl3_24_ranks_Plot.pdf", height = 7.5, width = 10)

ploten2 <- ploten2 +
  ggtitle("Plot Insample")
ggsave("D:/Daten/Insample_lvl3_24_ranks_Plot.pdf", height = 7.5, width = 10)