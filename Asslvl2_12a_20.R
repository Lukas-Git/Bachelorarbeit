...
AssDataWeights <- as.matrix(fread("D:/Daten/asmblglvl2/AssDataWeights2.csv",quote = "\""))
...
AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/AssDataY.csv",quote = "\""))
print(AssDataY)


insample <- (which(AssDataY[,2]==end.dates)-window.size-horizon.gap):(which(AssDataY[,2]==end.dates))
outsample <- (which(AssDataY[,2]==end.dates)+1):(nrow(AssDataY)-1)
print(outsample)
...
data.table::fwrite(ISDaten, "D:/Daten/asmblglvl2/Insample_solution_avgweights_lvl2_12a.csv")
data.table::fwrite(OOSDaten, "D:/Daten/asmblglvl2/Outofsample_solution_avgweights_lvl2_12a.csv")
saveRDS(Asslvl2, "D:/Daten/asmblglvl2/Asslvl2_12a.rds")

ploten1 <- ploten1 +
  ggtitle("Plot Outofsample")
ggsave("D:/Daten/Outofsample_lvl2_12a_Plot.pdf", height = 7.5, width = 10)

ploten2 <- ploten2 +
  ggtitle("Plot Insample")
ggsave("D:/Daten/Insample_lvl2_12a_Plot.pdf", height = 7.5, width = 10)
