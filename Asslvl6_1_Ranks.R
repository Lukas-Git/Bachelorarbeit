...
data.table::fwrite(ya, "D:/Daten/rankcoeff61.csv")

print(Asslvl2)
print(Asslvl2[["OOS"]])
print(Asslvl2[["All.in.sample.info"]][["Prediction"]])
data.table::fwrite(ISDaten, "D:/Daten/asmblglvl2/Insample_solution_lvl6_1_ranks.csv")
data.table::fwrite(OOSDaten, "D:/Daten/asmblglvl2/Outofsample_solution_lvl6_1_ranks.csv")
saveRDS(Asslvl2, "D:/Daten/asmblglvl2/Asslvl3_lvl6_1_ranks.rds")

ploten1 <- ploten1 +
  ggtitle("Plot Outofsample")
ggsave("D:/Daten/Outofsample_lvl6_1_ranks_Plot.pdf", height = 7.5, width = 10)

ploten2 <- ploten2 +
  ggtitle("Plot Insample")
ggsave("D:/Daten/Insample_lvl6_1_ranks_Plot.pdf", height = 7.5, width = 10)