...
.d <- `[`
{
  ...
  AssDatax <- as.matrix(fread("D:/Daten/asmblglvl2/AssDataxlvl6_avgo.csv",quote = "\""))
  ...
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl6_avgo.csv", quote = "\"" ))
  ...
  Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:216], 
                        x.weight = AssDataWeights[insample, 1:216], bench = AssDataBench[insample, 1:3],
                        pred.Y.OOS = AssDataY[outsample,1], comp.OOS = AssDatax[outsample, 1:216],
                        Bench.OOS = AssDataBench[outsample, 1:3], x.rank = AssDataRanks[insample3, 1:216],
  ...
  AssDatax <- as.matrix(fread("D:/Daten/asmblglvl2/AssDataxlvl3_avgo.csv",quote = "\""))
  class(AssDatax) <- "numeric"
  ...
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY24.csv",quote = "\""))
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl3_avgo.csv", quote = "\"" ))
  class(AssDataRanks) <- "numeric"
  ...
  Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:50], 
                        x.weight = AssDataWeights[insample, 1:50], bench = AssDataBench[insample, 1:3],
                        pred.Y.OOS = AssDataY[outsample,1], comp.OOS = AssDatax[outsample, 1:50],
                        Bench.OOS = AssDataBench[outsample, 1:3], x.rank = AssDataRanks[insample3, 1:50],
  ...
  AssDatax <- as.matrix(fread("D:/Daten/asmblglvl2/AssDatax_avgo.csv",quote = "\""))
  class(AssDatax) <- "numeric"
  ...
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY24.csv",quote = "\""))
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl2_avgo.csv", quote = "\"" ))
  class(AssDataRanks) <- "numeric"
  ...
  Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:15], 
                        x.weight = AssDataWeights[insample, 1:15], bench = AssDataBench[insample, 1:3],
                        pred.Y.OOS = AssDataY[outsample,1], comp.OOS = AssDatax[outsample, 1:15],
                        Bench.OOS = AssDataBench[outsample, 1:3], x.rank = AssDataRanks[insample3, 1:15],
