...
.d <- `[`
{
  ...
  AssDataWeights <- as.matrix(fread("D:/Daten/AssDataWeightslvl6_core2.csv",quote = "\""))
  ...
  Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:216], 
                        ...
                        Bench.OOS = AssDataBench[outsample, 1:3], x.rank = AssDataRanks[insample3,65:164],
                        rank.OOS = AssDataRanks[outsample3,65:164],
  ...
  class(AssDatax) <- "numeric"
  AssDataWeights <- as.matrix(fread("D:/Daten/AssDataWeightslvl3_core2.csv",quote = "\""))
  class(AssDataWeights) <- "numeric"
  AssDataBench <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataBench.csv",quote = "\""))
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY24.csv",quote = "\""))
  ...
  Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:50], 
                        ...
                        Bench.OOS = AssDataBench[outsample, 1:3], x.rank = AssDataRanks[insample3,16:38],
                        rank.OOS = AssDataRanks[outsample3,16:38],
  ...
  class(AssDatax) <- "numeric"
  AssDataWeights <- as.matrix(fread("D:/Daten/AssDataWeightslvl2_core2.csv",quote = "\""))
  class(AssDataWeights) <- "numeric"
  AssDataBench <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataBench.csv",quote = "\""))
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY24.csv",quote = "\""))
  ...
  Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:15], 
                        ...
                        Bench.OOS = AssDataBench[outsample, 1:3], x.rank = AssDataRanks[insample3, 5:11],
                        rank.OOS = AssDataRanks[outsample3,5:11],
...
print(tbl)
gtsave(tbl, "D:/Daten/table_RMSE_Comparison_Coreweights.pdf")