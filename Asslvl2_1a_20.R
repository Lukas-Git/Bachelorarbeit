...
Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:15], 
                      ...
                      train.size=1,
                      cores=cores, horizon.gap = horizon.gap, moving.average=1,
...
data.table::fwrite(ISDaten, "D:/Daten/asmblglvl2/Insample_solution_avgweights_lvl2_1a.csv")
data.table::fwrite(OOSDaten, "D:/Daten/asmblglvl2/Outofsample_solution_avgweights_lvl2_1a.csv")
saveRDS(Asslvl2, "D:/Daten/asmblglvl2/Asslvl2_1a.rds")

ploten1 <- ploten1 +
  ggtitle("Plot Outofsample")
ggsave("D:/Daten/Outofsample_lvl2_1a_Plot.pdf", height = 7.5, width = 10)

ploten2 <- ploten2 +
  ggtitle("Plot Insample")
ggsave("D:/Daten/Insample_lvl2_1a_Plot.pdf", height = 7.5, width = 10)