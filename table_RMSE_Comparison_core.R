...
.d <- `[`
{
  ...
  AssDatax <- as.matrix(fread("D:/Daten/asmblglvl2/AssDataxlvl6_core.csv",quote = "\""))
  class(AssDatax) <- "numeric"
  AssDataWeights <- as.matrix(fread("D:/Daten/AssDataWeightslvl6_core.csv",quote = "\""))
  ...
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl6_core.csv", quote = "\"" ))
  ...
  Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:183], 
                        x.weight = AssDataWeights[insample, 1:183], bench = AssDataBench[insample, 1:3],
                        pred.Y.OOS = AssDataY[outsample,1], comp.OOS = AssDatax[outsample, 1:183],
                        Bench.OOS = AssDataBench[outsample, 1:3], x.rank = AssDataRanks[insample3, 1:183],
                        rank.OOS = AssDataRanks[outsample3,1:183],
  ...
  AssDatax <- as.matrix(fread("D:/Daten/asmblglvl2/AssDataxlvl3_core.csv",quote = "\""))
  class(AssDatax) <- "numeric"
  AssDataWeights <- as.matrix(fread("D:/Daten/AssDataWeightslvl3_core.csv",quote = "\""))
  class(AssDataWeights) <- "numeric"
  AssDataBench <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataBench.csv",quote = "\""))
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY24.csv",quote = "\""))
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl3_core.csv", quote = "\"" ))
  class(AssDataRanks) <- "numeric"
  ...
  Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:44], 
                        x.weight = AssDataWeights[insample, 1:44], bench = AssDataBench[insample, 1:3],
                        pred.Y.OOS = AssDataY[outsample,1], comp.OOS = AssDatax[outsample, 1:44],
                        Bench.OOS = AssDataBench[outsample, 1:3], x.rank = AssDataRanks[insample3, 1:44],
                        rank.OOS = AssDataRanks[outsample3,1:44],
  ...
  AssDatax <- as.matrix(fread("D:/Daten/asmblglvl2/AssDataxlvl2_core.csv",quote = "\""))
  class(AssDatax) <- "numeric"
  AssDataWeights <- as.matrix(fread("D:/Daten/AssDataWeightslvl2_core.csv",quote = "\""))
  class(AssDataWeights) <- "numeric"
  AssDataBench <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataBench.csv",quote = "\""))
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY24.csv",quote = "\""))
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl2_core.csv", quote = "\"" ))
  class(AssDataRanks) <- "numeric"
  ...
  Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:12], 
                        x.weight = AssDataWeights[insample, 1:12], bench = AssDataBench[insample, 1:3],
                        pred.Y.OOS = AssDataY[outsample,1], comp.OOS = AssDatax[outsample, 1:12],
                        Bench.OOS = AssDataBench[outsample, 1:3], x.rank = AssDataRanks[insample3, 1:12],
                        rank.OOS = AssDataRanks[outsample3,1:12],
...
tbl <- gt(forecastingperformance) %>%
  ...
  tab_row_group(group = "Level 2(K=12)", rows = 1:2) %>%
  tab_row_group(group = "Level 3(K=44)", rows = 3:4) %>%
  tab_row_group(group = "Level 6(K=183)", rows = 5:6) %>%
...
print(tbl)
gtsave(tbl, "D:/Daten/table_RMSE_Comparison_average_weights.pdf")
