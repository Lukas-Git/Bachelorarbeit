library(data.table)
AssDatax <-fread("D:/Daten/asmblglvl2/AssDatax.csv",quote = "\"")
out <- c(5,7,13)
AssDatax <- AssDatax[, -out, with = FALSE]
data.table::fwrite(AssDatax, "D:/Daten/asmblglvl2/AssDataxlvl2_core.csv")
...
data.table::fwrite(mat_final, "D:/Daten/ranks_lvl2_core.csv")
