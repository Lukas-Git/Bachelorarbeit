...
.d <- `[`
{
  ...
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY24avgw.csv",quote = "\""))
  ...
  AssDataBench <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataBench.csv",quote = "\""))
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY12avgw.csv",quote = "\""))
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl6.csv", quote = "\"" ))
  class(AssDataRanks) <- "numeric"
  ...
  AssDataBench <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataBench.csv",quote = "\""))
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY6avgw.csv",quote = "\""))
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl6.csv", quote = "\"" ))
  class(AssDataRanks) <- "numeric"
  ...
  AssDataBench <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataBench.csv",quote = "\""))
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY3avgw.csv",quote = "\""))
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl6.csv", quote = "\"" ))
  class(AssDataRanks) <- "numeric"
  ...
  AssDataBench <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataBench.csv",quote = "\""))
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY1avgw.csv",quote = "\""))
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl6.csv", quote = "\"" ))
  class(AssDataRanks) <- "numeric"
