...
Asslvl2 <- assemblage(y = AssDataY[insample,1], x = AssDatax[insample, 1:15], 
                      ...
                      Bench.OOS = AssDataBench[outsample, 1:2], x.rank = c(), rank.OOS = c(),
                      
                      train.size=1,
                      cores=cores, horizon.gap = horizon.gap, moving.average=1,
                      model.select = c('rank','comp','Bench','BInt'), Progression=2)
...
data.table::fwrite(ISDaten, "D:/Daten/asmblglvl2/Insample_solution_avgweights_3_10.csv")
data.table::fwrite(OOSDaten, "D:/Daten/asmblglvl2/Outofsample_solution_avgweights_3_10.csv")
saveRDS(Asslvl2, "D:/Daten/asmblglvl2/Asslvl2_3_10.rds")

ploten1 <- ploten1 +
  ggtitle("Plot Outofsample")
ggsave("D:/Daten/Outofsample_lvl2_3_10_Plot.pdf", height = 7.5, width = 10)

ploten2 <- ploten2 +
  ggtitle("Plot Insample")
ggsave("D:/Daten/Insample_lvl2_3_10_Plot.pdf", height = 7.5, width = 10)
