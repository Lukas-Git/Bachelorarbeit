...
print(ploten1)
print(ploten2)
ya <- as.data.table(Asslvl2[["All.in.sample.info"]][["Coefficients"]][["Mod.comp"]])
data.table::fwrite(ya, "D:/Daten/rankcoeff624.csv")
...
data.table::fwrite(ISDaten, "D:/Daten/asmblglvl2/Insample_solution_lvl6_24_ranks.csv")
data.table::fwrite(OOSDaten, "D:/Daten/asmblglvl2/Outofsample_solution_lvl6_24_ranks.csv")
saveRDS(Asslvl2, "D:/Daten/asmblglvl2/Asslvl3_lvl6_24_ranks.rds")

ploten1 <- ploten1 +
  ggtitle("Plot Outofsample")
ggsave("D:/Daten/Outofsample_lvl6_24_ranks_Plot.pdf", height = 7.5, width = 10)

ploten2 <- ploten2 +
  ggtitle("Plot Insample")
ggsave("D:/Daten/Insample_lvl6_24_ranks_Plot.pdf", height = 7.5, width = 10)