...
.d <- `[`
{
  ...
  AssDatax <- as.matrix(fread("D:/Daten/asmblglvl2/AssDataxlvl6_avgi.csv",quote = "\""))
  ...
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl6_avgi.csv", quote = "\"" ))
  ...
  AssDatax <- as.matrix(fread("D:/Daten/asmblglvl2/AssDataxlvl3_avgi.csv",quote = "\""))
  class(AssDatax) <- "numeric"
  ...
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY24.csv",quote = "\""))
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl3_avgi.csv", quote = "\"" ))
  class(AssDataRanks) <- "numeric"
  ...
  AssDatax <- as.matrix(fread("D:/Daten/asmblglvl2/AssDatax_avgi.csv",quote = "\""))
  class(AssDatax) <- "numeric"
  ...
  class(AssDataBench) <- "numeric"
  AssDataY <- as.matrix(fread("D:/Daten/asmblglvl2/FinalAssDataY24.csv",quote = "\""))
  AssDataRanks <- as.matrix(fread("D:/Daten/ranks_lvl2_avgi.csv", quote = "\"" ))
  class(AssDataRanks) <- "numeric"
